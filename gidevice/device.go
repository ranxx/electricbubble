...
import (
	...
	"github.com/ranxx/electricbubble/gidevice/pkg/ipa"
	"github.com/ranxx/electricbubble/gidevice/pkg/libimobiledevice"
	"github.com/ranxx/electricbubble/gidevice/pkg/nskeyedarchiver"
...
func (d *device) XCTest(bundleID string, opts ...XCTestOption) (out <-chan string, cancel context.CancelFunc, err error) {
	...
	// see https://github.com/ranxx/electricbubble/gidevice/issues/31
